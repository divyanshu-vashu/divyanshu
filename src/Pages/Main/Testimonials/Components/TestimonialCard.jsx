			...
			<div className="relative">
						...
						src={
							testimonial.profile
								...
								: testimonial.gender.toLowerCase() === "male"
									? "https://res.cloudinary.com/dkezwrb3a/image/upload/Divyanshu/Portfolio/testimonials/Number117_vnezod.svg"
									: "https://res.cloudinary.com/Divyanshu/image/upload/v1694551283/Portfolio/testimonials/Number117_io2wji.svg"
						}
						alt="pfp"
					/>
				</div>
				...
				<div className="absolute right-0 w-5 h-5 overflow-hidden bottom-5">
					<img
						...
						src="https://res.cloudinary.com/Divyanshu/image/upload/v1725738488/india_zkbhzr.png"
						alt="flag"
					/>
